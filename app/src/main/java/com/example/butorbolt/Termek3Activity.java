...
public class Termek3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_termek3);
        exampleBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.szekreny3);
        ...
        postNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU && ActivityCompat.checkSelfPermission(Termek3Activity.this, Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
    ...
    private final ActivityResultLauncher<String> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        ...
        public void onActivityResult(Boolean o) {
            if (o) {
                Toast.makeText(Termek3Activity.this, "Post notification permission granted", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(Termek3Activity.this, "Post notification permission not granted", Toast.LENGTH_SHORT).show();
            }
        }
    });
    ...
    public void kosarba(android.view.View view) {
        Toast.makeText(Termek3Activity.this, "Termék kosárba helyezve", Toast.LENGTH_SHORT).show();
    }
}